...
#SBATCH --output="logs/training/t2_to_t1/FL/FedBN/global.out"
#SBATCH --error="logs/training/t2_to_t1/FL/FedBN/global.out"

DIR_NAME=logs/training/t2_to_t1/FL/FedBN
echo $DIR_NAME
