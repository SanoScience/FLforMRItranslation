...
#SBATCH --output="logs/training/t2_to_t1/FL/FedMean/global.out"
#SBATCH --error="logs/training/t2_to_t1/FL/FedMean/global.out"

DIR_NAME=logs/training/t2_to_t1/FL/FedMean
echo $DIR_NAME
...
srun --ntasks=1 --cpus-per-task=1 \
    ...
    $HOME/repos/FLforMRItranslation/run_server.py $PORT fedmean &
...
for client in "${clients[@]}"; do
    ...
    /net/pr2/projects/plgrid/plggflmri/Data/Internship/FL/$client $client $PORT fedmean &
done
wait