...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 3:
        ...
        n_patients = -1
    current_data_dir = "C:\\Users\\JanFiszer\\data\\mri\\HGG"
    target_root_dir = "C:\\Users\\JanFiszer\\data\\mri\\hgg_with_flair"
    n_patients = 5
    ...
    transformer.create_train_val_test_sets("*t1.nii.gz", "*t2.nii.gz", "*flair.nii.gz", n_patients=n_patients)
