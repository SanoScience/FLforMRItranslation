...
TRAINED_MODEL_CLIENT_DIR = f"../trained_models/client/model-lr{LEARNING_RATE}-ep{N_EPOCHS_CLIENT}"
TRAINED_MODEL_SERVER_DIR = f"../trained_models/server/model-lr{LEARNING_RATE}-ep{N_EPOCHS_CLIENT}"
